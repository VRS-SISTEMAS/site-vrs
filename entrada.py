...
# MÓDULO: entrada.py (ESTRUTURA 3 PÁGINAS - NAVEGAÇÃO COMPLETA)
# =================================================================
import streamlit as st
import sys
import os

# Força o Python a encontrar os arquivos na pasta]
sys.path.append(os.path.dirname(os.path.abspath(__file__)))

import botoes

# Tenta carregar o backend sem dar erro no VS Code
backend_ativo = False
try:
...
# Configuração de Layout e Sessão]
...
if st.session_state['etapa'] == 0:
    ...
    with col1:
        st.markdown('<div class="card-vrs"><div class="vrs-titulo">BÁSICO 🚀</div><div class="vrs-preco">R$ 99,99</div><div class="vrs-recursos">• Até 50 Veículos<br>• Gestão de Frota<br>• Suporte Standard</div></div>', unsafe_allow_html=True)
    ...
    with col2:
        st.markdown('<div class="card-vrs" style="border-color:#00FF7F;"><div class="vrs-titulo">JÚNIOR 🔥</div><div class="vrs-preco">R$ 139,99</div><div class="vrs-recursos">• Até 100 Veículos<br>• Histórico Completo<br>• Relatórios Premium</div></div>', unsafe_allow_html=True)
    ...
    with col3:
        st.markdown('<div class="card-vrs"><div class="vrs-titulo">SÊNIOR 💎</div><div class="vrs-preco">R$ 299,99</div><div class="vrs-recursos">• Até 500 Veículos<br>• Estoque e Peças<br>• Relatório PDF</div></div>', unsafe_allow_html=True)
...
# --- PÁGINA 2: CHECKOUT (CADASTRO E PAGAMENTO) ---
    ...
    st.markdown(f"### 💳 CHECKOUT ELITE: <span style='color:#00FF7F;'>{st.session_state.get('plano_vrs', '')}</span>", unsafe_allow_html=True)
